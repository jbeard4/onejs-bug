...
test.pkg("test", function(parents){

  return {
    'name'         : 'sax',
    'mainModuleId' : 'lib/sax',
    'modules'      : [],
    'parents'      : parents
  };

})({ 'lib/sax': function(module, exports, global, require, undefined){
...
})({ 'test': function(module, exports, global, require, undefined){
  var sax = require('sax');
